...
#### 3.Output files. Output files of *MetPre* are listed as Figure 5 shows.
...
![Figure5 Output files of *MetPre*](output files of MetPre.tif)
...
![Figure8 Number of component selction in PLS-DA analysis](PLS analysis.tif)
...
##### (5) "14heatmap" is the heatmap.
##### (6) "15marker selection" contains the information of markers, volcano plot and boxplots of markers.
##### (7) **"data_after_stat.csv", "qc.info.csv" and "subject.info"** are the data and sample information after statistical analysis.
##### (8) "intermediate" is the intermediate data during processing.
